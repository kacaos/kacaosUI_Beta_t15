...
if TukuiConfigUILocalization then
	if T.client == "deDE" then
		TukuiConfigUILocalization.unitframesmouseoverhighlight = "Aktiviere aufblinken der Raidframes per Mouseover in Raidlayout2"
		...
		TukuiConfigUILocalization.filgericonsize = "Setze Groesse der Icons"
		...
		TukuiConfigUILocalization.combattextdamagestyle = "Standard Schaden/Heilung Schriftart ueber Kreaturen/Spieler Koepfen aendern (nach /rl!)"
		...
		TukuiConfigUILocalization.combattextoverhealing = "Zeige ausgehende Ueberheilung an"
		TukuiConfigUILocalization.combattextpetdamage = "Zeige Begleiterschaden"
		TukuiConfigUILocalization.combattextdotdamage = "Zeige Schaden von Schaden ueber Zeit"
		TukuiConfigUILocalization.combattextdamagecolor = "Zeige Schadensnummern in Abhaengigkeit von der Art des Zaubers"
		...
		TukuiConfigUILocalization.combattexticonsize = "Symbolgroesse der Zauber im Fenster fuer ausgehenden Schaden. Nimmt auch Einfluss auf die Schriftgroesse"
		TukuiConfigUILocalization.combattexttreshold = "Ab welcher Groesse soll der Schaden angezeigt werden"
		TukuiConfigUILocalization.combattexthealtreshold = "Ab welche Groesse soll ein-/ausgehende Heilung angezeigt werden"
		...
		TukuiConfigUILocalization.combattextmergeaoespam = "Vereint mehrfachen Flaechenschaden in eine einzige Nachricht"
...
if T.client == "deDE" then
	...
	L.COMBATTEXTTESTUSEUNLOCK = "Gib '/xct' ein um die Kampftext Fenster freizugeben um sie verschieben und veraendern zu koennen."
	L.COMBATTEXTTESTUSELOCK = "Gib '/xct' ein um den Kampftext Testmodus zu sperren."
	L.COMBATTEXTTESTUSETEST = "Gib '/xct' ein um den Kampftext Testmodus zu aktivieren."
