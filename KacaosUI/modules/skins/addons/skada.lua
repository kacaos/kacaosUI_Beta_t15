...
if not C.skin.skadareskin then return end
...
barmod.ApplySettings = function(self, win)
	...
	if C.skin.skadaembedded and IsAddOnLoaded("Skada") then
			win.db.barwidth = (EmbeddingWindow:GetWidth() - 2)
			win.db.barheight = 15
			win.db.barmax = (math.floor((EmbeddingWindow:GetWidth()) / win.db.barheight) - 1)
