---------------------------------------------------------------------------------------------
-- Big Thanks to Sinaris and Nisha
---------------------------------------------------------------------------------------------
...
local KacaosAFKPanel = CreateFrame( "Frame", "KacaosAFKPanel", nil )
KacaosAFKPanel:SetPoint( "BOTTOMLEFT", UIParent, "BOTTOMLEFT", -2, -2 )
KacaosAFKPanel:SetPoint( "TOPRIGHT", UIParent, "BOTTOMRIGHT", 2, 150 )
KacaosAFKPanel:SetTemplate("Transparent")
--KacaosAFKPanel:CreateBorder(false, true)
KacaosAFKPanel:Hide()

local KacaosAFKPanelTop = CreateFrame( "Frame", "KacaosAFKPanelTop", nil )
KacaosAFKPanelTop:SetPoint( "TOPLEFT", UIParent, "TOPLEFT",-2, 2 )
KacaosAFKPanelTop:SetPoint( "BOTTOMRIGHT", UIParent, "TOPRIGHT", 2, -80 )
KacaosAFKPanelTop:SetTemplate("Transparent")
--KacaosAFKPanelTop:CreateBorder(false, true)
KacaosAFKPanelTop:SetFrameStrata("FULLSCREEN")
KacaosAFKPanelTop:Hide()

KacaosAFKPanelTop.AsphyxiaUIText = KacaosAFKPanelTop:CreateFontString( nil, "OVERLAY" )
KacaosAFKPanelTop.AsphyxiaUIText:SetPoint( "TOPLEFT", KacaosAFKPanelTop, "TOPLEFT", 15, -13 )
KacaosAFKPanelTop.AsphyxiaUIText:SetFont( C["media"]["font"], 30, "OUTLINE" )
KacaosAFKPanelTop.AsphyxiaUIText:SetText( "Kacaos"..cStart.."UI|r - "..GetAddOnMetadata( "KacaosUI", "Version" ) )

KacaosAFKPanelTop.AsphyxiaUIText2 = KacaosAFKPanelTop:CreateFontString( nil, "OVERLAY" )
KacaosAFKPanelTop.AsphyxiaUIText2:SetPoint( "TOPLEFT", KacaosAFKPanelTop, "TOPLEFT", 15, -35 )
KacaosAFKPanelTop.AsphyxiaUIText2:SetFont( C["media"]["font"], 15, "OUTLINE" )
KacaosAFKPanelTop.AsphyxiaUIText2:SetText( cStart..T.level.."|r".." "..T.myname.." - "..cStart..UnitClass("player") )

KacaosAFKPanelTop.ClockText = KacaosAFKPanelTop:CreateFontString( nil, "OVERLAY" )
KacaosAFKPanelTop.ClockText:SetPoint( "TOPRIGHT", KacaosAFKPanelTop, "TOPRIGHT", -15, -13 )
KacaosAFKPanelTop.ClockText:SetFont( C["media"]["font"], 30, "OUTLINE" )
-- KacaosAFKPanelTop.ClockText:SetTextColor( 0.7, 0.7, 0.7 )

KacaosAFKPanelTop.DateText = KacaosAFKPanelTop:CreateFontString( nil, "OVERLAY" )
KacaosAFKPanelTop.DateText:SetPoint( "TOPRIGHT", KacaosAFKPanelTop, "TOPRIGHT", -15, -35 )
KacaosAFKPanelTop.DateText:SetFont( C["media"]["font"], 15, "OUTLINE" )
-- KacaosAFKPanelTop.DateText:SetTextColor( 0.7, 0.7, 0.7 )

local KacaosAFKPanelToplogo = CreateFrame("Frame", nil, KacaosAFKPanelTop)
KacaosAFKPanelToplogo:SetPoint("CENTER", KacaosAFKPanelTop, "CENTER", 0, 0 )
KacaosAFKPanelToplogo:Size(150, 75)
local KacaosAFKPanelToplogo_tex = KacaosAFKPanelToplogo:CreateTexture(nil, "OVERLAY")
KacaosAFKPanelToplogo_tex:SetTexture(C.media.wowlogo)
KacaosAFKPanelToplogo_tex:SetPoint("TOPLEFT", KacaosAFKPanelToplogo, "TOPLEFT", 2, -2)
KacaosAFKPanelToplogo_tex:SetPoint("BOTTOMRIGHT", KacaosAFKPanelToplogo, "BOTTOMRIGHT", -2, 2)

local interval = 0
KacaosAFKPanelTop:SetScript( "OnUpdate", function( self, elapsed )
		interval = interval - elapsed
	if( interval <= 0 ) then
		KacaosAFKPanelTop.ClockText:SetText( format("%s", date( "%H:%M:%S" ) ) )
		KacaosAFKPanelTop.DateText:SetText( format("%s", date( cStart.."%a|r".." %d. %B" ) ) )
		interval = .5
	end
end )
...
KacaosAFKPanel:RegisterEvent( "PLAYER_ENTERING_WORLD" )
KacaosAFKPanel:RegisterEvent( "PLAYER_LEAVING_WORLD" )
KacaosAFKPanel:RegisterEvent( "PLAYER_FLAGS_CHANGED" )
KacaosAFKPanel:SetScript( "OnEvent", OnEvent )

local texts = T.AFK_LIST
local interval = #texts

local KacaosAFKScrollFrame = CreateFrame( "ScrollingMessageFrame", "KacaosAFKScrollFrame", KacaosAFKPanel )
KacaosAFKScrollFrame:SetSize( KacaosAFKPanel:GetWidth(), KacaosAFKPanel:GetHeight() )
KacaosAFKScrollFrame:SetPoint( "CENTER", KacaosAFKPanel, "CENTER", 0, 60 )
KacaosAFKScrollFrame:SetFont( C["media"]["font"], 20, "OUTLINE" )
KacaosAFKScrollFrame:SetShadowColor( 0, 0, 0, 0 )
KacaosAFKScrollFrame:SetFading( false )
KacaosAFKScrollFrame:SetFadeDuration( 0 )
KacaosAFKScrollFrame:SetTimeVisible( 1 )
KacaosAFKScrollFrame:SetMaxLines( 1 )
KacaosAFKScrollFrame:SetSpacing( 2 )
KacaosAFKScrollFrame:SetScript( "OnUpdate", function( self, time )
interval = interval - ( time / 30 )
for index, name in pairs( T.AFK_LIST ) do
	if( interval < index ) then
		KacaosAFKScrollFrame:AddMessage( T.AFK_LIST[index], 1, 1, 1)
		tremove( texts, index )
	end
end
...
KacaosAFKPanel:SetScript( "OnShow", function( self ) UIFrameFadeIn( UIParent, .5, 1, 0 ) end )
KacaosAFKPanel:SetScript( "OnHide", function( self ) UIFrameFadeOut( UIParent, .5, 0, 1 ) end )
